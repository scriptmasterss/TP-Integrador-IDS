"""validadores para articulos."""

import validadores.general

LLAVES_OBLIGATORIAS = ["nombre", "tipo", "seccion"]

MAPA_VALIDADORES = {
    "nombre": validadores.general.texto,
    "tipo": validadores.general.texto,
    "seccion": validadores.general.texto,
    "stock": validadores.general.numero_positivo,
